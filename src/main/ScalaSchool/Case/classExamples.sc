...
// Classes in Scala are parameterized with constructor arguments. The code above defines two constructor arguments, x and y;
...
// The program defines an executable application Classes in the form of a top-level singleton object with a main method.
...
// which automatically creates an internal property val name: String in the class:
